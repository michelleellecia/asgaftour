        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownPortfolio">
                  <a class="dropdown-item" href="<?= base_url(); ?>paket">Malaysia</a>
			...
			<li class="nav-item">
				<a class="nav-link" href="<?= base_url(); ?>tentang_kami">About Us</a>
			</li>
			<li class="nav-item">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownBlog">
              <a class="dropdown-item" href="<?= base_url(); ?>tips_dan_trik">Tips and Trick</a>
              <a class="dropdown-item" href="blog-home-2.html">Experience</a>
          ...
          <div class="row ml-3">
            ...
            <?php else : ?>
              <div class="col">
                <a href="<?= base_url('auth_user'); ?>" class="btn"><b>Login</b></a>
              </div>
              <div class="col">
                <a href="<?= base_url('auth'); ?>" class="btn">|</a>
              </div>
              <div class="col">
                <a href="<?= base_url('auth_user/registration'); ?>" class="btn"><b>Register</b></a> 
              </div>
            <?php endif; ?>
          </div>
        </ul>
